...
export default function EditPatientScreen() {
  ...
  const { patients, addPatient } = useContext(AppContext);
  ...
  return (
    <>
      <Stack.Screen
        options={{
          headerShown: true,
          headerTitle: existingPatient ? 'Editar Paciente' : 'Agregar Paciente',
          headerStyle: {
            backgroundColor: '#000',
          },
          headerTintColor: '#FFF',
          headerRight: () => (
            <TouchableOpacity
              ...
              style={[styles.saveHeaderButton, !isFormValid && styles.saveHeaderButtonDisabled]}
            >
              <Save size={20} color={isFormValid ? "#FFF" : "#666"} />
            </TouchableOpacity>
          ),
        }}
      />
